...
//
// SHARED PRIMITIVES. Consumed by both the baseline text-tile engine
// (src/PhraseVideo.tsx, src/SceneBackdrops.tsx) and the forthcoming premium
// render path (src/premium/*). Do not put engine-specific logic here.
